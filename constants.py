...
from utils.trading_algorithms.run_mock_algorithmic_scalping_backtest import run_mock_algorithmic_scalping_backtest
...
active_algorithm = run_mock_algorithmic_scalping_backtest
